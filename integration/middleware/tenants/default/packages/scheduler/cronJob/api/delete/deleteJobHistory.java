...
public final class deleteJobHistory {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.scheduler.cronJob.api.delete.deleteJobHistory";
		...
		passThroughData.put("flowRef", "packages/scheduler/cronJob/api/delete/deleteJobHistory.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteJobHistory", new Exception(e));
		}finally{
			try{
