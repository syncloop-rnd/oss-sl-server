...
public final class getSchedulerList {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.scheduler.cronJob.api.get.getSchedulerList";
		...
		passThroughData.put("flowRef", "packages/scheduler/cronJob/api/get/getSchedulerList.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getSchedulerList", new Exception(e));
		}finally{
			try{
