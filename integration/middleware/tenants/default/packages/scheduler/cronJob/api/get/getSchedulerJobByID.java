package packages.scheduler.cronJob.api.get;
...
public final class getSchedulerJobByID {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.scheduler.cronJob.api.get.getSchedulerJobByID";
		...
		passThroughData.put("flowRef", "packages/scheduler/cronJob/api/get/getSchedulerJobByID.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getSchedulerJobByID", new Exception(e));
		}finally{
			try{
