package packages.scheduler.cronJob.api.delete;
...
public final class deleteSchedulerJob {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.scheduler.cronJob.api.delete.deleteSchedulerJob";
		...
		passThroughData.put("flowRef", "packages/scheduler/cronJob/api/delete/deleteSchedulerJob.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteSchedulerJob", new Exception(e));
		}finally{
			try{
