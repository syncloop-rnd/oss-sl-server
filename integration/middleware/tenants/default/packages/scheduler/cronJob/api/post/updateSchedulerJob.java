package packages.scheduler.cronJob.api.post;
...
public final class updateSchedulerJob {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.scheduler.cronJob.api.post.updateSchedulerJob";
		...
		passThroughData.put("flowRef", "packages/scheduler/cronJob/api/post/updateSchedulerJob.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateSchedulerJob", new Exception(e));
		}finally{
			try{
