...
public final class createSchedulerJob {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.scheduler.cronJob.api.post.createSchedulerJob";
		...
		passThroughData.put("flowRef", "packages/scheduler/cronJob/api/post/createSchedulerJob.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createSchedulerJob", new Exception(e));
		}finally{
			try{
