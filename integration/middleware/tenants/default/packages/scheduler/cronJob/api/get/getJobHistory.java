...
public final class getJobHistory {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.scheduler.cronJob.api.get.getJobHistory";
		...
		passThroughData.put("flowRef", "packages/scheduler/cronJob/api/get/getJobHistory.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getJobHistory", new Exception(e));
		}finally{
			try{
