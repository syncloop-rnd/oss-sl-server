...
public final class startJob {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.scheduler.cronJob.handler.startJob";
		...
		passThroughData.put("flowRef", "packages/scheduler/cronJob/handler/startJob.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute startJob", new Exception(e));
		}finally{
			try{
