...
public final class loadSchedulerJobs {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.scheduler.cronJob.handler.loadSchedulerJobs";
		...
		passThroughData.put("flowRef", "packages/scheduler/cronJob/handler/loadSchedulerJobs.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute loadSchedulerJobs", new Exception(e));
		}finally{
			try{
