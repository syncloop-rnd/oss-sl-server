...
public final class loadJobsAndStartScheduler {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.scheduler.cronJob.handler.loadJobsAndStartScheduler";
		...
		passThroughData.put("flowRef", "packages/scheduler/cronJob/handler/loadJobsAndStartScheduler.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute loadJobsAndStartScheduler", new Exception(e));
		}finally{
			try{
