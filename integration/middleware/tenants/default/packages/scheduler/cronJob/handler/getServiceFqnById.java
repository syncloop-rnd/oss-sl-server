...
public final class getServiceFqnById {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.scheduler.cronJob.handler.getServiceFqnById";
		...
		passThroughData.put("flowRef", "packages/scheduler/cronJob/handler/getServiceFqnById.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getServiceFqnById", new Exception(e));
		}finally{
			try{
