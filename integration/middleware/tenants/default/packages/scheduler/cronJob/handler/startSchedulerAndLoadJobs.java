package packages.scheduler.cronJob.handler;
...
public final class startSchedulerAndLoadJobs {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.scheduler.cronJob.handler.startSchedulerAndLoadJobs";
		...
		passThroughData.put("flowRef", "packages/scheduler/cronJob/handler/startSchedulerAndLoadJobs.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute startSchedulerAndLoadJobs", new Exception(e));
		}finally{
			try{
