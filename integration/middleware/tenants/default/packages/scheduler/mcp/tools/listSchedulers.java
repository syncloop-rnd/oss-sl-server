package packages.scheduler.mcp.tools;
...
public final class listSchedulers {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.scheduler.mcp.tools.listSchedulers";
		...
		passThroughData.put("flowRef", "packages/scheduler/mcp/tools/listSchedulers.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listSchedulers", new Exception(e));
		}finally{
			try{
