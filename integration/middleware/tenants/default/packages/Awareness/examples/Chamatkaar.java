...
public final class Chamatkaar {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.examples.Chamatkaar";
		...
		passThroughData.put("flowRef", "packages/Awareness/examples/Chamatkaar.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute Chamatkaar", new Exception(e));
		}finally{
			try{
