...
public final class SLCodeGenerator {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.examples.SLCodeGenerator";
		...
		passThroughData.put("flowRef", "packages/Awareness/examples/SLCodeGenerator.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute SLCodeGenerator", new Exception(e));
		}finally{
			try{
