...
public final class ImportAllTenantsAPI {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.examples.ImportAllTenantsAPI";
		...
		passThroughData.put("flowRef", "packages/Awareness/examples/ImportAllTenantsAPI.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute ImportAllTenantsAPI", new Exception(e));
		}finally{
			try{
