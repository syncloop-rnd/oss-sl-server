...
public final class TestApi {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.examples.TestApi";
		...
		passThroughData.put("flowRef", "packages/Awareness/examples/TestApi.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute TestApi", new Exception(e));
		}finally{
			try{
