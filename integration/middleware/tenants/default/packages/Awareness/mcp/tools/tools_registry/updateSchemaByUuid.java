...
public final class updateSchemaByUuid {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.mcp.tools.tools_registry.updateSchemaByUuid";
		...
		passThroughData.put("flowRef", "packages/Awareness/mcp/tools/tools_registry/updateSchemaByUuid.api");
