...
public final class addApp {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.mcp.tools.addApp";
		...
		passThroughData.put("flowRef", "packages/Awareness/mcp/tools/addApp.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute addApp", new Exception(e));
		}finally{
			try{
