...
public final class getAllApps {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.mcp.tools.getAllApps";
		...
		passThroughData.put("flowRef", "packages/Awareness/mcp/tools/getAllApps.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAllApps", new Exception(e));
		}finally{
			try{
