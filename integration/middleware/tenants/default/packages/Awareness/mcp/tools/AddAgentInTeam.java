...
public final class AddAgentInTeam {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.mcp.tools.AddAgentInTeam";
		...
		passThroughData.put("flowRef", "packages/Awareness/mcp/tools/AddAgentInTeam.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute AddAgentInTeam", new Exception(e));
		}finally{
			try{
