...
public final class generateUUID {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.mcp.tools.generateUUID";
		...
		passThroughData.put("flowRef", "packages/Awareness/mcp/tools/generateUUID.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute generateUUID", new Exception(e));
		}finally{
			try{
