package packages.Awareness.mcp.tools.mcp;
...
public final class getByPaging {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.mcp.tools.mcp.getByPaging";
		...
		passThroughData.put("flowRef", "packages/Awareness/mcp/tools/mcp/getByPaging.api");
