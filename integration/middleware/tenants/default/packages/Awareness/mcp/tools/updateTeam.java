...
public final class updateTeam {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.mcp.tools.updateTeam";
		...
		passThroughData.put("flowRef", "packages/Awareness/mcp/tools/updateTeam.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateTeam", new Exception(e));
		}finally{
			try{
