package packages.Awareness.mcp.tools;
...
public final class clearChatHistory {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.mcp.tools.clearChatHistory";
		...
		passThroughData.put("flowRef", "packages/Awareness/mcp/tools/clearChatHistory.api");
