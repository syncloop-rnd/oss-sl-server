...
public final class getAppTeams {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.mcp.tools.getAppTeams";
		...
		passThroughData.put("flowRef", "packages/Awareness/mcp/tools/getAppTeams.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAppTeams", new Exception(e));
		}finally{
			try{
