...
public final class getToolRegistryByMcpId {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.mcp.tools.tools_registry.getToolRegistryByMcpId";
		...
		passThroughData.put("flowRef", "packages/Awareness/mcp/tools/tools_registry/getToolRegistryByMcpId.api");
