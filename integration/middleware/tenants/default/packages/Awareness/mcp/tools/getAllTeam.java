...
public final class getAllTeam {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.mcp.tools.getAllTeam";
		...
		passThroughData.put("flowRef", "packages/Awareness/mcp/tools/getAllTeam.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAllTeam", new Exception(e));
		}finally{
			try{
