...
public final class getTeam {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.mcp.tools.getTeam";
		...
		passThroughData.put("flowRef", "packages/Awareness/mcp/tools/getTeam.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getTeam", new Exception(e));
		}finally{
			try{
