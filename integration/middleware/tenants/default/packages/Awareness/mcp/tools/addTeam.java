...
public final class addTeam {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.mcp.tools.addTeam";
		...
		passThroughData.put("flowRef", "packages/Awareness/mcp/tools/addTeam.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute addTeam", new Exception(e));
		}finally{
			try{
