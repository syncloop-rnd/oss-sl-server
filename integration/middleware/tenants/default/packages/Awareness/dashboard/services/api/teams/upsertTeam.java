...
public final class upsertTeam {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.teams.upsertTeam";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/teams/upsertTeam.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute upsertTeam", new Exception(e));
		}finally{
			try{
