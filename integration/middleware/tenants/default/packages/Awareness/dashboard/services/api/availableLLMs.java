...
public final class availableLLMs {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.availableLLMs";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/availableLLMs.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute availableLLMs", new Exception(e));
		}finally{
			try{
