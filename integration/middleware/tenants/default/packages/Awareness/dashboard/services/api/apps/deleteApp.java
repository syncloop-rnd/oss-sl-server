...
public final class deleteApp {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.apps.deleteApp";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/apps/deleteApp.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteApp", new Exception(e));
		}finally{
			try{
