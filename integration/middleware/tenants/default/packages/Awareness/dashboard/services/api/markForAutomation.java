...
public final class markForAutomation {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.markForAutomation";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/markForAutomation.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute markForAutomation", new Exception(e));
		}finally{
			try{
