...
public final class GetToolRegistryByMcpId {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.tools_registry.GetToolRegistryByMcpId";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/tools_registry/GetToolRegistryByMcpId.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute GetToolRegistryByMcpId", new Exception(e));
		}finally{
			try{
