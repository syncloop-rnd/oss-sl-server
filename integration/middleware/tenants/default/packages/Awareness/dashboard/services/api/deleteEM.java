...
public final class deleteEM {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.deleteEM";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/deleteEM.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteEM", new Exception(e));
		}finally{
			try{
