...
public final class createRAG {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.createRAG";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/createRAG.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createRAG", new Exception(e));
		}finally{
			try{
