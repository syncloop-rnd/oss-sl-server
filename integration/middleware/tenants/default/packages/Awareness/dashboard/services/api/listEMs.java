...
public final class listEMs {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.listEMs";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/listEMs.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listEMs", new Exception(e));
		}finally{
			try{
