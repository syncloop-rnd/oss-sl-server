...
public final class getAgent {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.getAgent";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/getAgent.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAgent", new Exception(e));
		}finally{
			try{
