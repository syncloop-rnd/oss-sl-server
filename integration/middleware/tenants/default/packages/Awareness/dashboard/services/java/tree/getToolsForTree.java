...
public final class getToolsForTree {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.java.tree.getToolsForTree";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/java/tree/getToolsForTree.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getToolsForTree", new Exception(e));
		}finally{
			try{
