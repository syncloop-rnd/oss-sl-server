...
public final class addRAG {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.addRAG";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/addRAG.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute addRAG", new Exception(e));
		}finally{
			try{
