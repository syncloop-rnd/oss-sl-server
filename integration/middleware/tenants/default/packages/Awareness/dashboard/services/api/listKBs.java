...
public final class listKBs {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.listKBs";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/listKBs.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listKBs", new Exception(e));
		}finally{
			try{
