package packages.Awareness.dashboard.services.api.teams;
...
public final class getTeamAgentsByTeamId {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.teams.getTeamAgentsByTeamId";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/teams/getTeamAgentsByTeamId.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getTeamAgentsByTeamId", new Exception(e));
		}finally{
			try{
