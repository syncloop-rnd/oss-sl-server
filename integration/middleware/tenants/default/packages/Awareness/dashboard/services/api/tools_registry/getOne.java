...
public final class getOne {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.tools_registry.getOne";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/tools_registry/getOne.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getOne", new Exception(e));
		}finally{
			try{
