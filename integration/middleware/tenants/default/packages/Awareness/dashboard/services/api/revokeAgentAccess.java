package packages.Awareness.dashboard.services.api;
...
public final class revokeAgentAccess {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.revokeAgentAccess";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/revokeAgentAccess.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute revokeAgentAccess", new Exception(e));
		}finally{
			try{
