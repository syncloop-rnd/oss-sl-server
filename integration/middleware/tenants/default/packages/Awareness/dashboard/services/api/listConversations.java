...
public final class listConversations {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.listConversations";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/listConversations.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listConversations", new Exception(e));
		}finally{
			try{
