...
public final class fetchTeams {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.teams.fetchTeams";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/teams/fetchTeams.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute fetchTeams", new Exception(e));
		}finally{
			try{
