...
public final class getTeamsByAppId {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.teams.getTeamsByAppId";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/teams/getTeamsByAppId.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getTeamsByAppId", new Exception(e));
		}finally{
			try{
