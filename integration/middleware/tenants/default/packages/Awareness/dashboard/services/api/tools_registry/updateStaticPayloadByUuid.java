package packages.Awareness.dashboard.services.api.tools_registry;
...
public final class updateStaticPayloadByUuid {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.tools_registry.updateStaticPayloadByUuid";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/tools_registry/updateStaticPayloadByUuid.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateStaticPayloadByUuid", new Exception(e));
		}finally{
			try{
