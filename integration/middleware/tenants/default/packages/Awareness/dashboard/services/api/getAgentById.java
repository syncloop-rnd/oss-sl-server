...
public final class getAgentById {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.getAgentById";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/getAgentById.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAgentById", new Exception(e));
		}finally{
			try{
