...
public final class deleteKB {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.deleteKB";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/deleteKB.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteKB", new Exception(e));
		}finally{
			try{
