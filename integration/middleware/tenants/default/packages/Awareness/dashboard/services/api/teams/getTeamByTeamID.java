...
public final class getTeamByTeamID {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.teams.getTeamByTeamID";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/teams/getTeamByTeamID.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getTeamByTeamID", new Exception(e));
		}finally{
			try{
