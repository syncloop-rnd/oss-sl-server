...
public final class createEM {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.createEM";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/createEM.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createEM", new Exception(e));
		}finally{
			try{
