...
public final class getConversation {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.getConversation";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/getConversation.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getConversation", new Exception(e));
		}finally{
			try{
