...
public final class deleteTool {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.deleteTool";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/deleteTool.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteTool", new Exception(e));
		}finally{
			try{
