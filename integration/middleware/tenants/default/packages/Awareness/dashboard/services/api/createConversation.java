...
public final class createConversation {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.createConversation";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/createConversation.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createConversation", new Exception(e));
		}finally{
			try{
