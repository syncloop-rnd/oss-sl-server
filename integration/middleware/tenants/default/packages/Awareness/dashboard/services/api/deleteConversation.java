...
public final class deleteConversation {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.deleteConversation";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/deleteConversation.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteConversation", new Exception(e));
		}finally{
			try{
