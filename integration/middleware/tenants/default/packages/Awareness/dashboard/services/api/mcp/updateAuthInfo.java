package packages.Awareness.dashboard.services.api.mcp;
...
public final class updateAuthInfo {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.mcp.updateAuthInfo";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/mcp/updateAuthInfo.api");
