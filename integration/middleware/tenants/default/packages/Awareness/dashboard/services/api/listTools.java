...
public final class listTools {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.listTools";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/listTools.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listTools", new Exception(e));
		}finally{
			try{
