...
public final class agentSettings {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.agentSettings";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/agentSettings.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute agentSettings", new Exception(e));
		}finally{
			try{
