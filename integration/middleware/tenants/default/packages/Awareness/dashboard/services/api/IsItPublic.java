...
public final class IsItPublic {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.IsItPublic";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/IsItPublic.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute IsItPublic", new Exception(e));
		}finally{
			try{
