...
public final class saveKB {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.saveKB";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/saveKB.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute saveKB", new Exception(e));
		}finally{
			try{
