...
public final class listModels {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.listModels";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/listModels.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listModels", new Exception(e));
		}finally{
			try{
