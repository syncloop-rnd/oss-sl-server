...
public final class createAgent {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.createAgent";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/createAgent.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createAgent", new Exception(e));
		}finally{
			try{
