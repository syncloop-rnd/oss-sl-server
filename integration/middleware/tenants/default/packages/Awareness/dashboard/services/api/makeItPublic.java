...
public final class makeItPublic {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.makeItPublic";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/makeItPublic.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute makeItPublic", new Exception(e));
		}finally{
			try{
