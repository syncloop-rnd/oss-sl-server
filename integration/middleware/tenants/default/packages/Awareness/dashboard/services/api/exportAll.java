...
public final class exportAll {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.exportAll";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/exportAll.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute exportAll", new Exception(e));
		}finally{
			try{
