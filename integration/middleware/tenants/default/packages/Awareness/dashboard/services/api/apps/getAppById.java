package packages.Awareness.dashboard.services.api.apps;
...
public final class getAppById {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.apps.getAppById";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/apps/getAppById.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAppById", new Exception(e));
		}finally{
			try{
