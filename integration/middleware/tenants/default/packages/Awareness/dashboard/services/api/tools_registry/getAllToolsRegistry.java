...
public final class getAllToolsRegistry {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.tools_registry.getAllToolsRegistry";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/tools_registry/getAllToolsRegistry.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAllToolsRegistry", new Exception(e));
		}finally{
			try{
