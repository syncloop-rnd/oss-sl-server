...
public final class updateAuthInfo {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.agent_tools.updateAuthInfo";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/agent_tools/updateAuthInfo.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateAuthInfo", new Exception(e));
		}finally{
			try{
