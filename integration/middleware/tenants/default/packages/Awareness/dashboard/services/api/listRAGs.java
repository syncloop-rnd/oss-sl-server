...
public final class listRAGs {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.listRAGs";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/listRAGs.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listRAGs", new Exception(e));
		}finally{
			try{
