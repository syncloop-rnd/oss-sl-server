...
public final class importAll {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.importAll";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/importAll.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute importAll", new Exception(e));
		}finally{
			try{
