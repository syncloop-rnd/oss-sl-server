...
public final class upsertApp {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.apps.upsertApp";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/apps/upsertApp.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute upsertApp", new Exception(e));
		}finally{
			try{
