package packages.Awareness.dashboard.services.api.automation;
...
public final class getLLM {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.automation.getLLM";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/automation/getLLM.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getLLM", new Exception(e));
		}finally{
			try{
