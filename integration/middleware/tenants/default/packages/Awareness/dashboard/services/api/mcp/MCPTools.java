...
public final class MCPTools {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.mcp.MCPTools";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/mcp/MCPTools.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute MCPTools", new Exception(e));
		}finally{
			try{
