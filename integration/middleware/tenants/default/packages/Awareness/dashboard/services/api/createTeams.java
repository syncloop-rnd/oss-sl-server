...
public final class createTeams {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.createTeams";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/createTeams.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createTeams", new Exception(e));
		}finally{
			try{
