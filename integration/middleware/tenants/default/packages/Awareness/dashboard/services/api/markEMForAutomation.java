...
public final class markEMForAutomation {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.markEMForAutomation";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/markEMForAutomation.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute markEMForAutomation", new Exception(e));
		}finally{
			try{
