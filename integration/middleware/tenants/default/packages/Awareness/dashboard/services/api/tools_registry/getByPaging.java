...
public final class getByPaging {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.tools_registry.getByPaging";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/tools_registry/getByPaging.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getByPaging", new Exception(e));
		}finally{
			try{
