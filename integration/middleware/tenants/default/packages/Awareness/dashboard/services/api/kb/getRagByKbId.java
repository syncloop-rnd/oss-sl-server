package packages.Awareness.dashboard.services.api.kb;
...
public final class getRagByKbId {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.kb.getRagByKbId";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/kb/getRagByKbId.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getRagByKbId", new Exception(e));
		}finally{
			try{
