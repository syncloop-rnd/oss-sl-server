...
public final class addTool {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.addTool";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/addTool.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute addTool", new Exception(e));
		}finally{
			try{
