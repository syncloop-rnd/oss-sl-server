...
public final class createLLMSpec {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.createLLMSpec";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/createLLMSpec.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createLLMSpec", new Exception(e));
		}finally{
			try{
