package packages.Awareness.dashboard.services.api.agent_tools;
...
public final class getAllAgentTools {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.agent_tools.getAllAgentTools";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/agent_tools/getAllAgentTools.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAllAgentTools", new Exception(e));
		}finally{
			try{
