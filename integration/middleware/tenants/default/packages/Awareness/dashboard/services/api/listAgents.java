...
public final class listAgents {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.listAgents";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/listAgents.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listAgents", new Exception(e));
		}finally{
			try{
