...
public final class getByPaging {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.mcp.getByPaging";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/mcp/getByPaging.api");
