...
public final class fetchApps {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.apps.fetchApps";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/apps/fetchApps.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute fetchApps", new Exception(e));
		}finally{
			try{
