...
public final class studio {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.automation.studio";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/automation/studio.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute studio", new Exception(e));
		}finally{
			try{
