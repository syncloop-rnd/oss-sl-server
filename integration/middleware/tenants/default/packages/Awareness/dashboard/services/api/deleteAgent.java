...
public final class deleteAgent {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.deleteAgent";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/deleteAgent.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteAgent", new Exception(e));
		}finally{
			try{
