...
public final class getByPaging {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.agent_tools.getByPaging";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/agent_tools/getByPaging.api");
