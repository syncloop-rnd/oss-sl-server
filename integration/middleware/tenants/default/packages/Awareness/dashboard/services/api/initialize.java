...
public final class initialize {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.initialize";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/initialize.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute initialize", new Exception(e));
		}finally{
			try{
