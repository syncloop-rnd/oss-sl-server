...
public final class deleteTeam {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.teams.deleteTeam";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/teams/deleteTeam.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteTeam", new Exception(e));
		}finally{
			try{
