...
public final class delete {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.agent_tools.delete";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/agent_tools/delete.api");
