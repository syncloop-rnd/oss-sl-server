...
public final class createDefaultAgents {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.dashboard.services.api.createDefaultAgents";
		...
		passThroughData.put("flowRef", "packages/Awareness/dashboard/services/api/createDefaultAgents.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createDefaultAgents", new Exception(e));
		}finally{
			try{
