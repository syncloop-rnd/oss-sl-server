...
public final class execute {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.cli.execute";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/cli/execute.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute execute", new Exception(e));
		}finally{
			try{
