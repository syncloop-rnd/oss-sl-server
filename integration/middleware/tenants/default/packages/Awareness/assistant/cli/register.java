...
public final class register {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.cli.register";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/cli/register.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute register", new Exception(e));
		}finally{
			try{
