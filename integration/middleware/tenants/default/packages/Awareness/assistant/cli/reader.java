...
public final class reader {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.cli.reader";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/cli/reader.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute reader", new Exception(e));
		}finally{
			try{
