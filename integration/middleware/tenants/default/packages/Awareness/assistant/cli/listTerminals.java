package packages.Awareness.assistant.cli;
...
public final class listTerminals {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.cli.listTerminals";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/cli/listTerminals.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listTerminals", new Exception(e));
		}finally{
			try{
