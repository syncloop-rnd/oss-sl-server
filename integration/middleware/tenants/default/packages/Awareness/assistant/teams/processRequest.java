...
public final class processRequest {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.teams.processRequest";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/teams/processRequest.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute processRequest", new Exception(e));
		}finally{
			try{
