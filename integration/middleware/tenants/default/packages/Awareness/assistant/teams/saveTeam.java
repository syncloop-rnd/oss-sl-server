package packages.Awareness.assistant.teams;
...
public final class saveTeam {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.teams.saveTeam";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/teams/saveTeam.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute saveTeam", new Exception(e));
		}finally{
			try{
