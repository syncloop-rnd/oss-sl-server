package packages.Awareness.assistant.tools;
...
public final class clearChatHistory {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.tools.clearChatHistory";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/tools/clearChatHistory.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute clearChatHistory", new Exception(e));
		}finally{
			try{
