...
public final class askAgent {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.tools.askAgent";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/tools/askAgent.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute askAgent", new Exception(e));
		}finally{
			try{
