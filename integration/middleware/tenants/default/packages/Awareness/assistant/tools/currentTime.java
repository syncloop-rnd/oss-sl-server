...
public final class currentTime {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.tools.currentTime";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/tools/currentTime.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute currentTime", new Exception(e));
		}finally{
			try{
