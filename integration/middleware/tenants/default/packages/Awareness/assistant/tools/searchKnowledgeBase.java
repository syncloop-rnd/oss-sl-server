...
public final class searchKnowledgeBase {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.tools.searchKnowledgeBase";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/tools/searchKnowledgeBase.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute searchKnowledgeBase", new Exception(e));
		}finally{
			try{
