...
public final class get_action_details {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.api.get_action_details";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/api/get_action_details.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute get_action_details", new Exception(e));
		}finally{
			try{
