...
public final class execute_action {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.api.execute_action";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/api/execute_action.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute execute_action", new Exception(e));
		}finally{
			try{
