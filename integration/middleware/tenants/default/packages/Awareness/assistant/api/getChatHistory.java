...
public final class getChatHistory {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.api.getChatHistory";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/api/getChatHistory.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getChatHistory", new Exception(e));
		}finally{
			try{
