...
public final class list_available_actions {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.api.list_available_actions";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/api/list_available_actions.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute list_available_actions", new Exception(e));
		}finally{
			try{
