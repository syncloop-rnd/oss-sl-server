...
public final class chat {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.api.chat";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/api/chat.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute chat", new Exception(e));
		}finally{
			try{
