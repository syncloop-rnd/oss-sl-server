package packages.Awareness.assistant.api;
...
public final class search_tool_vector {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.api.search_tool_vector";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/api/search_tool_vector.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute search_tool_vector", new Exception(e));
		}finally{
			try{
