...
public final class likeMessage {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.api.likeMessage";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/api/likeMessage.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute likeMessage", new Exception(e));
		}finally{
			try{
