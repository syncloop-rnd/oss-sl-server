...
public final class unlikeMessage {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.api.unlikeMessage";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/api/unlikeMessage.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute unlikeMessage", new Exception(e));
		}finally{
			try{
