package packages.Awareness.assistant.apps;
...
public final class executeApp {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Awareness.assistant.apps.executeApp";
		...
		passThroughData.put("flowRef", "packages/Awareness/assistant/apps/executeApp.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute executeApp", new Exception(e));
		}finally{
			try{
