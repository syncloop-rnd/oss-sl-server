...
public final class listToolsByMcpId {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.listToolsByMcpId";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/listToolsByMcpId.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listToolsByMcpId", new Exception(e));
		}finally{
			try{
