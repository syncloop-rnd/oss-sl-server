...
public final class getInterceptorApi {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.interceptor.getInterceptorApi";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/interceptor/getInterceptorApi.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getInterceptorApi", new Exception(e));
		}finally{
			try{
