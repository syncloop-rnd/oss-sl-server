...
public final class getOAuthSetup {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.getOAuthSetup";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/getOAuthSetup.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getOAuthSetup", new Exception(e));
		}finally{
			try{
