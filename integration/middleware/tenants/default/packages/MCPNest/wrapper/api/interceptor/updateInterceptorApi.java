...
public final class updateInterceptorApi {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.interceptor.updateInterceptorApi";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/interceptor/updateInterceptorApi.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateInterceptorApi", new Exception(e));
		}finally{
			try{
