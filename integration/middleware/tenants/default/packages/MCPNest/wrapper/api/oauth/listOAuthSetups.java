...
public final class listOAuthSetups {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.listOAuthSetups";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/listOAuthSetups.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listOAuthSetups", new Exception(e));
		}finally{
			try{
