...
public final class migrateMcpNestDatabase {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.migrateMcpNestDatabase";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/migrateMcpNestDatabase.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute migrateMcpNestDatabase", new Exception(e));
		}finally{
			try{
