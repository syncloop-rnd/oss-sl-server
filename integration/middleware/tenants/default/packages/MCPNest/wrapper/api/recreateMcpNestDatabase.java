...
public final class recreateMcpNestDatabase {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.recreateMcpNestDatabase";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/recreateMcpNestDatabase.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute recreateMcpNestDatabase", new Exception(e));
		}finally{
			try{
