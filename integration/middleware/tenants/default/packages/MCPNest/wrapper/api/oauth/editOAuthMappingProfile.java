...
public final class editOAuthMappingProfile {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.editOAuthMappingProfile";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/editOAuthMappingProfile.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute editOAuthMappingProfile", new Exception(e));
		}finally{
			try{
