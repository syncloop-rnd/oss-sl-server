package packages.MCPNest.wrapper.api.interceptor;
...
public final class updateCollectionToolInterceptorRefs {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.interceptor.updateCollectionToolInterceptorRefs";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/interceptor/updateCollectionToolInterceptorRefs.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateCollectionToolInterceptorRefs", new Exception(e));
		}finally{
			try{
