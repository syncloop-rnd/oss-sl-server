...
public final class listMcpCategories {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.listMcpCategories";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/listMcpCategories.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listMcpCategories", new Exception(e));
		}finally{
			try{
