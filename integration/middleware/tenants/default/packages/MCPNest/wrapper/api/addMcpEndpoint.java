...
public final class addMcpEndpoint {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.addMcpEndpoint";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/addMcpEndpoint.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute addMcpEndpoint", new Exception(e));
		}finally{
			try{
