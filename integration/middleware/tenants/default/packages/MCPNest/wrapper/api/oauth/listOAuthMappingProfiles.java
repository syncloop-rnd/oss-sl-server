...
public final class listOAuthMappingProfiles {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.listOAuthMappingProfiles";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/listOAuthMappingProfiles.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listOAuthMappingProfiles", new Exception(e));
		}finally{
			try{
