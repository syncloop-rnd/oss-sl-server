...
public final class listMcps {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.listMcps";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/listMcps.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listMcps", new Exception(e));
		}finally{
			try{
