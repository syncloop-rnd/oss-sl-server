...
public final class deleteOAuthToken {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.deleteOAuthToken";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/deleteOAuthToken.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteOAuthToken", new Exception(e));
		}finally{
			try{
