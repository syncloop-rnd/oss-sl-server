package packages.MCPNest.wrapper.api.oauth;
...
public final class deleteOAuthMappingProfile {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.deleteOAuthMappingProfile";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/deleteOAuthMappingProfile.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteOAuthMappingProfile", new Exception(e));
		}finally{
			try{
