...
public final class refreshMcpTools {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.refreshMcpTools";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/refreshMcpTools.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute refreshMcpTools", new Exception(e));
		}finally{
			try{
