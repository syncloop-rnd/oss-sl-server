...
public final class addOAuthSetup {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.addOAuthSetup";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/addOAuthSetup.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute addOAuthSetup", new Exception(e));
		}finally{
			try{
