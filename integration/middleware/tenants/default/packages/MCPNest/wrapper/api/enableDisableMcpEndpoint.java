...
public final class enableDisableMcpEndpoint {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.enableDisableMcpEndpoint";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/enableDisableMcpEndpoint.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute enableDisableMcpEndpoint", new Exception(e));
		}finally{
			try{
