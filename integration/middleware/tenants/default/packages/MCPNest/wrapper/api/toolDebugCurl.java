...
public final class toolDebugCurl {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.toolDebugCurl";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/toolDebugCurl.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute toolDebugCurl", new Exception(e));
		}finally{
			try{
