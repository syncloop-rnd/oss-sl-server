...
public final class enableDisableToolInCollection {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.enableDisableToolInCollection";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/enableDisableToolInCollection.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute enableDisableToolInCollection", new Exception(e));
		}finally{
			try{
