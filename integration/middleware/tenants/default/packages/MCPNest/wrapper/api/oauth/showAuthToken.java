...
public final class showAuthToken {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.showAuthToken";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/showAuthToken.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute showAuthToken", new Exception(e));
		}finally{
			try{
