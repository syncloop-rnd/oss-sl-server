...
public final class deleteMcpEndpoint {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.deleteMcpEndpoint";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/deleteMcpEndpoint.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteMcpEndpoint", new Exception(e));
		}finally{
			try{
