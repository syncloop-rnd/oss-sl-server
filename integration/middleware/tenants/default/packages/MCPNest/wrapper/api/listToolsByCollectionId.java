package packages.MCPNest.wrapper.api;
...
public final class listToolsByCollectionId {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.listToolsByCollectionId";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/listToolsByCollectionId.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listToolsByCollectionId", new Exception(e));
		}finally{
			try{
