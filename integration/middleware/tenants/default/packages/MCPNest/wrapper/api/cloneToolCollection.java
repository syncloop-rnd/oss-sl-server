...
public final class cloneToolCollection {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.cloneToolCollection";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/cloneToolCollection.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute cloneToolCollection", new Exception(e));
		}finally{
			try{
