...
public final class updateMcpToolCacheSettings {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.interceptor.updateMcpToolCacheSettings";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/interceptor/updateMcpToolCacheSettings.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateMcpToolCacheSettings", new Exception(e));
		}finally{
			try{
