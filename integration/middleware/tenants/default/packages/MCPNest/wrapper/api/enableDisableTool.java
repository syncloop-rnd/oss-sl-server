...
public final class enableDisableTool {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.enableDisableTool";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/enableDisableTool.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute enableDisableTool", new Exception(e));
		}finally{
			try{
