...
public final class getDashboardStats {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.getDashboardStats";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/getDashboardStats.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getDashboardStats", new Exception(e));
		}finally{
			try{
