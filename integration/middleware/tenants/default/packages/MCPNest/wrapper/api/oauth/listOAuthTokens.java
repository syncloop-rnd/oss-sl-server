...
public final class listOAuthTokens {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.listOAuthTokens";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/listOAuthTokens.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listOAuthTokens", new Exception(e));
		}finally{
			try{
