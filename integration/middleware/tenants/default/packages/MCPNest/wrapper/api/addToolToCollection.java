...
public final class addToolToCollection {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.addToolToCollection";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/addToolToCollection.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute addToolToCollection", new Exception(e));
		}finally{
			try{
