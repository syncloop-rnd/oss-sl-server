...
public final class deleteToolCollection {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.deleteToolCollection";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/deleteToolCollection.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteToolCollection", new Exception(e));
		}finally{
			try{
