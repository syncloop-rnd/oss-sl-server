...
public final class getToolUsageDetails {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.getToolUsageDetails";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/getToolUsageDetails.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getToolUsageDetails", new Exception(e));
		}finally{
			try{
