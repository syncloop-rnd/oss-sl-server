...
public final class testOAuthAuthorization {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.testOAuthAuthorization";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/testOAuthAuthorization.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute testOAuthAuthorization", new Exception(e));
		}finally{
			try{
