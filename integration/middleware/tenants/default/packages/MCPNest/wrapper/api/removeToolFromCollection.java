...
public final class removeToolFromCollection {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.removeToolFromCollection";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/removeToolFromCollection.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute removeToolFromCollection", new Exception(e));
		}finally{
			try{
