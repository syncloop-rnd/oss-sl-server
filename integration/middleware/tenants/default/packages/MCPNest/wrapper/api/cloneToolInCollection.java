...
public final class cloneToolInCollection {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.cloneToolInCollection";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/cloneToolInCollection.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute cloneToolInCollection", new Exception(e));
		}finally{
			try{
