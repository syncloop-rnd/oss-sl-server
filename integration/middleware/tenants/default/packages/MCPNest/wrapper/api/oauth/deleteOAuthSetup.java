...
public final class deleteOAuthSetup {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.deleteOAuthSetup";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/deleteOAuthSetup.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteOAuthSetup", new Exception(e));
		}finally{
			try{
