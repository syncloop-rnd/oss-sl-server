...
public final class getOAuthMappingProfile {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.getOAuthMappingProfile";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/getOAuthMappingProfile.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getOAuthMappingProfile", new Exception(e));
		}finally{
			try{
