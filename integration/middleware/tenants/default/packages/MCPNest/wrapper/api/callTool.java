...
public final class callTool {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.callTool";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/callTool.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute callTool", new Exception(e));
		}finally{
			try{
