...
public final class editOAuthSetup {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.editOAuthSetup";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/editOAuthSetup.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute editOAuthSetup", new Exception(e));
		}finally{
			try{
