...
public final class deleteMcpTool {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.deleteMcpTool";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/deleteMcpTool.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteMcpTool", new Exception(e));
		}finally{
			try{
