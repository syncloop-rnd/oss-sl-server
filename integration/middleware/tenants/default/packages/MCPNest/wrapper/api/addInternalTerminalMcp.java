...
public final class addInternalTerminalMcp {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.addInternalTerminalMcp";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/addInternalTerminalMcp.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute addInternalTerminalMcp", new Exception(e));
		}finally{
			try{
