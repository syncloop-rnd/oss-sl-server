...
public final class applyOAuthMappingProfile {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.applyOAuthMappingProfile";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/applyOAuthMappingProfile.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute applyOAuthMappingProfile", new Exception(e));
		}finally{
			try{
