...
public final class updateMcpToolInterceptorRefs {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.interceptor.updateMcpToolInterceptorRefs";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/interceptor/updateMcpToolInterceptorRefs.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateMcpToolInterceptorRefs", new Exception(e));
		}finally{
			try{
