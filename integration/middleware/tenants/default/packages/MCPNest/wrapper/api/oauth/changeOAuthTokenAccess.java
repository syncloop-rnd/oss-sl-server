...
public final class changeOAuthTokenAccess {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.changeOAuthTokenAccess";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/changeOAuthTokenAccess.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute changeOAuthTokenAccess", new Exception(e));
		}finally{
			try{
