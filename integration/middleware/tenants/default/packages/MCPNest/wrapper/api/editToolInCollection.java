...
public final class editToolInCollection {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.editToolInCollection";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/editToolInCollection.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute editToolInCollection", new Exception(e));
		}finally{
			try{
