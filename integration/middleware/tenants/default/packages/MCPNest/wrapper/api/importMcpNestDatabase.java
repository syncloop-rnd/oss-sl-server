...
public final class importMcpNestDatabase {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.importMcpNestDatabase";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/importMcpNestDatabase.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute importMcpNestDatabase", new Exception(e));
		}finally{
			try{
