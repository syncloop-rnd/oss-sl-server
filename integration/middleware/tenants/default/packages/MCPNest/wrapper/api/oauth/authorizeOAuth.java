...
public final class authorizeOAuth {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.authorizeOAuth";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/authorizeOAuth.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute authorizeOAuth", new Exception(e));
		}finally{
			try{
