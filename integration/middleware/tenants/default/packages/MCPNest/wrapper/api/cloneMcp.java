...
public final class cloneMcp {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.cloneMcp";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/cloneMcp.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute cloneMcp", new Exception(e));
		}finally{
			try{
