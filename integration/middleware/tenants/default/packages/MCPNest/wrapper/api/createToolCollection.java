...
public final class createToolCollection {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.createToolCollection";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/createToolCollection.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createToolCollection", new Exception(e));
		}finally{
			try{
