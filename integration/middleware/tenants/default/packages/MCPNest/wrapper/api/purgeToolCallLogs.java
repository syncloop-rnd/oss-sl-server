...
public final class purgeToolCallLogs {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.purgeToolCallLogs";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/purgeToolCallLogs.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute purgeToolCallLogs", new Exception(e));
		}finally{
			try{
