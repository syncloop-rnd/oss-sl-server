...
public final class exportMcpNestDatabase {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.exportMcpNestDatabase";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/exportMcpNestDatabase.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute exportMcpNestDatabase", new Exception(e));
		}finally{
			try{
