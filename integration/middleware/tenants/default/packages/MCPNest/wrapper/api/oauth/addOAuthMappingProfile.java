...
public final class addOAuthMappingProfile {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.addOAuthMappingProfile";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/addOAuthMappingProfile.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute addOAuthMappingProfile", new Exception(e));
		}finally{
			try{
