...
public final class mergeDefaultOAuthCatalog {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.mergeDefaultOAuthCatalog";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/mergeDefaultOAuthCatalog.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute mergeDefaultOAuthCatalog", new Exception(e));
		}finally{
			try{
