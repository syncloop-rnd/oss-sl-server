...
public final class deleteInterceptorApi {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.interceptor.deleteInterceptorApi";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/interceptor/deleteInterceptorApi.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteInterceptorApi", new Exception(e));
		}finally{
			try{
