...
public final class listCollections {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.listCollections";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/listCollections.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listCollections", new Exception(e));
		}finally{
			try{
