...
public final class oauthCallback {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.oauthCallback";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/oauthCallback.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute oauthCallback", new Exception(e));
		}finally{
			try{
