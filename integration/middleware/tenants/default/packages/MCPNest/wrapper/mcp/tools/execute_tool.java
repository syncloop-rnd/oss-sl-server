...
public final class execute_tool {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.mcp.tools.execute_tool";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/mcp/tools/execute_tool.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute execute_tool", new Exception(e));
		}finally{
			try{
