package packages.MCPNest.wrapper.mcp.tools;
...
public final class list_enabled_tools {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.mcp.tools.list_enabled_tools";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/mcp/tools/list_enabled_tools.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute list_enabled_tools", new Exception(e));
		}finally{
			try{
