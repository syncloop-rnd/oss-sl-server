...
public final class tool_details {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.mcp.tools.tool_details";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/mcp/tools/tool_details.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute tool_details", new Exception(e));
		}finally{
			try{
