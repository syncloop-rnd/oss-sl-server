...
public final class listOAuthCategories {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.MCPNest.wrapper.api.oauth.listOAuthCategories";
		...
		passThroughData.put("flowRef", "packages/MCPNest/wrapper/api/oauth/listOAuthCategories.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listOAuthCategories", new Exception(e));
		}finally{
			try{
