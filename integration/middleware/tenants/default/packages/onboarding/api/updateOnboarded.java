...
public final class updateOnboarded {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.onboarding.api.updateOnboarded";
		...
		passThroughData.put("flowRef", "packages/onboarding/api/updateOnboarded.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateOnboarded", new Exception(e));
		}finally{
			try{
