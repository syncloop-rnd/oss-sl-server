...
public final class updatePassword {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.onboarding.api.updatePassword";
		...
		passThroughData.put("flowRef", "packages/onboarding/api/updatePassword.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updatePassword", new Exception(e));
		}finally{
			try{
