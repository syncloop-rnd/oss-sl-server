...
public final class sendWelcomeEmail {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.onboarding.api.sendWelcomeEmail";
		...
		passThroughData.put("flowRef", "packages/onboarding/api/sendWelcomeEmail.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute sendWelcomeEmail", new Exception(e));
		}finally{
			try{
