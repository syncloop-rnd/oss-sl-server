package packages.onboarding.api;
...
public final class sendResetPasswordMail {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.onboarding.api.sendResetPasswordMail";
		...
		passThroughData.put("flowRef", "packages/onboarding/api/sendResetPasswordMail.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute sendResetPasswordMail", new Exception(e));
		}finally{
			try{
