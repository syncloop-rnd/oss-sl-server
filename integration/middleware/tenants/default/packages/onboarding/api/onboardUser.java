...
public final class onboardUser {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.onboarding.api.onboardUser";
		...
		passThroughData.put("flowRef", "packages/onboarding/api/onboardUser.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute onboardUser", new Exception(e));
		}finally{
			try{
