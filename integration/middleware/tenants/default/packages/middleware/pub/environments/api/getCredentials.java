...
public final class getCredentials {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.getCredentials";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/getCredentials.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getCredentials", new Exception(e));
		}finally{
			try{
