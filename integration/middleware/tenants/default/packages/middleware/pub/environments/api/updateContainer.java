...
public final class updateContainer {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.updateContainer";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/updateContainer.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateContainer", new Exception(e));
		}finally{
			try{
