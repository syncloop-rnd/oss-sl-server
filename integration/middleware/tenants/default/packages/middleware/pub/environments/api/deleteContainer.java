...
public final class deleteContainer {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.deleteContainer";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/deleteContainer.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteContainer", new Exception(e));
		}finally{
			try{
