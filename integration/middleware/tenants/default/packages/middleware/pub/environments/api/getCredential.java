...
public final class getCredential {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.getCredential";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/getCredential.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getCredential", new Exception(e));
		}finally{
			try{
