...
public final class getHostedDomainGoDaddy {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.getHostedDomainGoDaddy";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/getHostedDomainGoDaddy.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getHostedDomainGoDaddy", new Exception(e));
		}finally{
			try{
