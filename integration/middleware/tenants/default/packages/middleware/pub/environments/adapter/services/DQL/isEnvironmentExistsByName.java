...
public final class isEnvironmentExistsByName {
		...
		try{
		  if(mainSqlJsonObject==null)
			synchronized(syncBlock){
			  ...
			  String flowRef = location+"packages/middleware/pub/environments/adapter/services/DQL/isEnvironmentExistsByName.sql";
			  if(mainSqlJsonObject==null)
		  ...
		  SqlResolver.execute(dataPipeline,mainSqlJsonObject);
			...
			new SnippetException(dataPipeline,"Failed to execute isEnvironmentExistsByName", new Exception(e));
		}
	}
}
