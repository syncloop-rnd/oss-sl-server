...
public final class getDomainRegistrar {
		...
		try{
		  if(mainSqlJsonObject==null)
			synchronized(syncBlock){
			  ...
			  String flowRef = location+"packages/middleware/pub/environments/adapter/services/DQL/getDomainRegistrar.sql";
			  if(mainSqlJsonObject==null)
		  ...
		  SqlResolver.execute(dataPipeline,mainSqlJsonObject);
			...
			new SnippetException(dataPipeline,"Failed to execute getDomainRegistrar", new Exception(e));
		}
	}
}
