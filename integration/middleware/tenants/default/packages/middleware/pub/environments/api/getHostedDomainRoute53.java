...
public final class getHostedDomainRoute53 {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.getHostedDomainRoute53";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/getHostedDomainRoute53.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getHostedDomainRoute53", new Exception(e));
		}finally{
			try{
