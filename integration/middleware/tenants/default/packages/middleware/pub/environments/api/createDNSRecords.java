...
public final class createDNSRecords {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.createDNSRecords";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/createDNSRecords.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createDNSRecords", new Exception(e));
		}finally{
			try{
