...
public final class deployContainer {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.deployContainer";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/deployContainer.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deployContainer", new Exception(e));
		}finally{
			try{
