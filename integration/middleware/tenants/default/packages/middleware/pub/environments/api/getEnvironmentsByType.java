...
public final class getEnvironmentsByType {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.getEnvironmentsByType";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/getEnvironmentsByType.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getEnvironmentsByType", new Exception(e));
		}finally{
			try{
