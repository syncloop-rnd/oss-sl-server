...
public final class updateCredential {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.updateCredential";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/updateCredential.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateCredential", new Exception(e));
		}finally{
			try{
