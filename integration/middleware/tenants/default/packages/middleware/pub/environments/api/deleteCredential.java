...
public final class deleteCredential {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.deleteCredential";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/deleteCredential.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteCredential", new Exception(e));
		}finally{
			try{
