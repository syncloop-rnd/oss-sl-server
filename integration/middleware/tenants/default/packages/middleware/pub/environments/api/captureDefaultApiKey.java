...
public final class captureDefaultApiKey {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.captureDefaultApiKey";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/captureDefaultApiKey.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute captureDefaultApiKey", new Exception(e));
		}finally{
			try{
