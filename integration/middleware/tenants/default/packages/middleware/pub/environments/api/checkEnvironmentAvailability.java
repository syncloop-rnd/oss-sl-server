package packages.middleware.pub.environments.api;
...
public final class checkEnvironmentAvailability {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.checkEnvironmentAvailability";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/checkEnvironmentAvailability.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute checkEnvironmentAvailability", new Exception(e));
		}finally{
			try{
