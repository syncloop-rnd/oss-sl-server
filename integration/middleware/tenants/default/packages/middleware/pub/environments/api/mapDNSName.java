...
public final class mapDNSName {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.mapDNSName";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/mapDNSName.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute mapDNSName", new Exception(e));
		}finally{
			try{
