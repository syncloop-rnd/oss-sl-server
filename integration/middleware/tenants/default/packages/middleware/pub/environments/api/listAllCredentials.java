...
public final class listAllCredentials {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.listAllCredentials";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/listAllCredentials.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute listAllCredentials", new Exception(e));
		}finally{
			try{
