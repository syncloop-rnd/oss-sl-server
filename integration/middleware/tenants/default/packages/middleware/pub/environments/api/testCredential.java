...
public final class testCredential {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.testCredential";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/testCredential.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute testCredential", new Exception(e));
		}finally{
			try{
