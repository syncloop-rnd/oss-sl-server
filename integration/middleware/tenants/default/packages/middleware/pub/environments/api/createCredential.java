...
public final class createCredential {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.environments.api.createCredential";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/environments/api/createCredential.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createCredential", new Exception(e));
		}finally{
			try{
