...
public final class defaultConfig {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.util.ai.defaultConfig";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/util/ai/defaultConfig.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute defaultConfig", new Exception(e));
		}finally{
			try{
