package packages.middleware.pub.util.ai;
...
public final class createSyncloopApi {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.util.ai.createSyncloopApi";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/util/ai/createSyncloopApi.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createSyncloopApi", new Exception(e));
		}finally{
			try{
