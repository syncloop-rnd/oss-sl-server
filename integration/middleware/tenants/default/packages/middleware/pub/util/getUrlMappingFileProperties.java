...
public final class getUrlMappingFileProperties{
...
private static void readFile(DataPipeline dataPipeline) throws Exception {
        ...
        String filePath = PropertyManager.getUrlMappingFolderPath(dataPipeline);
        Properties props = PropertyManager.getUrlMappingProperties(dataPipeline);
