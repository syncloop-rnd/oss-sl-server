...
public final class saveUrlMappingPropertiesApi {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.util.saveUrlMappingPropertiesApi";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/util/saveUrlMappingPropertiesApi.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute saveUrlMappingPropertiesApi", new Exception(e));
		}finally{
			try{
