...
public final class saveServerPropertiesAPI {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.util.saveServerPropertiesAPI";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/util/saveServerPropertiesAPI.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute saveServerPropertiesAPI", new Exception(e));
		}finally{
			try{
