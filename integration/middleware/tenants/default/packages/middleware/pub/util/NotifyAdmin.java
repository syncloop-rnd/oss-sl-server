...
public final class NotifyAdmin {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.util.NotifyAdmin";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/util/NotifyAdmin.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute NotifyAdmin", new Exception(e));
		}finally{
			try{
