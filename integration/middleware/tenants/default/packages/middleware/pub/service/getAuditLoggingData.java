...
public final class getAuditLoggingData {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.service.getAuditLoggingData";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/service/getAuditLoggingData.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAuditLoggingData", new Exception(e));
		}finally{
			try{
