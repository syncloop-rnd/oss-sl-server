...
public final class getAuditLoggingDataV2 {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.service.getAuditLoggingDataV2";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/service/getAuditLoggingDataV2.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAuditLoggingDataV2", new Exception(e));
		}finally{
			try{
