...
public final class DeleteSnap {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.service.DeleteSnap";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/service/DeleteSnap.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute DeleteSnap", new Exception(e));
		}finally{
			try{
