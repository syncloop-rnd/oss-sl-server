...
public final class auditLogging {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		...
		passThroughData.put("flowRef", "packages/middleware/pub/service/auditLogging.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute auditLogging", new Exception(e));
		}finally{
			try{
