...
public final class DeleteTestCase {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.service.DeleteTestCase";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/service/DeleteTestCase.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute DeleteTestCase", new Exception(e));
		}finally{
			try{
