...
public final class findAuditLoggingByFQN {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.service.findAuditLoggingByFQN";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/service/findAuditLoggingByFQN.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute findAuditLoggingByFQN", new Exception(e));
		}finally{
			try{
