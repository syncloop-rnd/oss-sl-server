...
public final class Wait {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.service.Wait";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/service/Wait.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute Wait", new Exception(e));
		}finally{
			try{
