...
public final class getIntegration {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.integrations.flow.getIntegration";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/integrations/flow/getIntegration.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getIntegration", new Exception(e));
		}finally{
			try{
