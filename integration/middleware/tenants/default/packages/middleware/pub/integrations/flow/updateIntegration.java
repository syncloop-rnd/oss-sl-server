...
public final class updateIntegration {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.integrations.flow.updateIntegration";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/integrations/flow/updateIntegration.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateIntegration", new Exception(e));
		}finally{
			try{
