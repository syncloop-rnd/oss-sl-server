...
public final class deleteIntegration {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.integrations.flow.deleteIntegration";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/integrations/flow/deleteIntegration.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteIntegration", new Exception(e));
		}finally{
			try{
