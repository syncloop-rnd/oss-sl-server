		...
		try{
		  ...
		  if(mainSqlJsonObject==null)
			synchronized(syncBlock){
			  ...
			  String flowRef = location+"packages/middleware/pub/integrations/adapter/services/DML/deleteById.sql";
			  if(mainSqlJsonObject==null){
		  ...
		  SqlResolver.execute(dataPipeline,mainSqlJsonObject);
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteById", new Exception(e));
		}
	}
}
