...
public final class insertIntegrations {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.integrations.flow.insertIntegrations";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/integrations/flow/insertIntegrations.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute insertIntegrations", new Exception(e));
		}finally{
			try{
