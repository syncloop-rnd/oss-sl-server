		...
		try{
		  ...
		  if(mainSqlJsonObject==null)
			synchronized(syncBlock){
			  ...
			  String flowRef = location+"packages/middleware/pub/integrations/adapter/services/DQL/findById.sql";
			  if(mainSqlJsonObject==null){
		  ...
		  SqlResolver.execute(dataPipeline,mainSqlJsonObject);
			...
			throw new SnippetException(dataPipeline,"Failed to execute findById", new Exception(e));
		}
	}
}
