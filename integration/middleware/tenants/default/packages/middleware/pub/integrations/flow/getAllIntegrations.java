package packages.middleware.pub.integrations.flow;
...
public final class getAllIntegrations {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.integrations.flow.getAllIntegrations";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/integrations/flow/getAllIntegrations.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAllIntegrations", new Exception(e));
		}finally{
			try{
