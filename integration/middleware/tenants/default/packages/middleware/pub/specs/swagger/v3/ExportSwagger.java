...
public final class ExportSwagger {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.specs.swagger.v3.ExportSwagger";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/specs/swagger/v3/ExportSwagger.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute ExportSwagger", new Exception(e));
		}finally{
			try{
