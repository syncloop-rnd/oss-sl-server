...
public final class publishToMarketplace {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.specs.postman.v3.publishToMarketplace";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/specs/postman/v3/publishToMarketplace.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute publishToMarketplace", new Exception(e));
		}finally{
			try{
