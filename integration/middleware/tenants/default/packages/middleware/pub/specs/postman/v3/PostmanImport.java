...
public final class PostmanImport {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.specs.postman.v3.PostmanImport";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/specs/postman/v3/PostmanImport.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute PostmanImport", new Exception(e));
		}finally{
			try{
