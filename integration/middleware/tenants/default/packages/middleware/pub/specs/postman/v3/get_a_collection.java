...
public final class get_a_collection {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.specs.postman.v3.get_a_collection";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/specs/postman/v3/get_a_collection.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute get_a_collection", new Exception(e));
		}finally{
			try{
