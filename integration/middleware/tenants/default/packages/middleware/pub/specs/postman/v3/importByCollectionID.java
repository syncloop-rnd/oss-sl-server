...
public final class importByCollectionID {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.specs.postman.v3.importByCollectionID";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/specs/postman/v3/importByCollectionID.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute importByCollectionID", new Exception(e));
		}finally{
			try{
