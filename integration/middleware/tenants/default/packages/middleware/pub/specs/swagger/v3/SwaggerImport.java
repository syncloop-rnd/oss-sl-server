...
public final class SwaggerImport {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.specs.swagger.v3.SwaggerImport";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/specs/swagger/v3/SwaggerImport.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute SwaggerImport", new Exception(e));
		}finally{
			try{
