...
public final class Generate{
	...
	try {
      	dataPipeline.appLog("OPERATION", "Generate");
      	String fqn=dataPipeline.getString("fqn");
      	dataPipeline.appLog("FQN", "FQN Value: " + fqn);
        List<String> fqns = Lists.newArrayList(fqn.split(","));
        ...
        Boolean isDownloadable = dataPipeline.getAsBoolean("isDownloadable");
