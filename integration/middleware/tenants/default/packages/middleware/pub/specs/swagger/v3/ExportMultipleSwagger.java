...
public final class ExportMultipleSwagger {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.specs.swagger.v3.ExportMultipleSwagger";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/specs/swagger/v3/ExportMultipleSwagger.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute ExportMultipleSwagger", new Exception(e));
		}finally{
			try{
