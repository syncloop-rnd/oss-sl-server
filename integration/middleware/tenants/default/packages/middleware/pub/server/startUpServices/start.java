...
public final class start {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.startUpServices.start";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/startUpServices/start.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute start", new Exception(e));
		}finally{
			try{
