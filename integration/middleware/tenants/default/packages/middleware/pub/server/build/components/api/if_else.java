...
public final class if_else {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.build.components.api.if_else";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/build/components/api/if_else.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute if_else", new Exception(e));
		}finally{
			try{
