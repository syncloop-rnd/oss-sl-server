...
public final class serviceLogs {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.browse.serviceLogs";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/browse/serviceLogs.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute serviceLogs", new Exception(e));
		}finally{
			try{
