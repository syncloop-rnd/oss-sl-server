...
public final class group {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.build.components.api.group";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/build/components/api/group.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute group", new Exception(e));
		}finally{
			try{
