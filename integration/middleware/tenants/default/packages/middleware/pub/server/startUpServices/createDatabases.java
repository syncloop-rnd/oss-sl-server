package packages.middleware.pub.server.startUpServices;
...
public final class createDatabases {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.startUpServices.createDatabases";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/startUpServices/createDatabases.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createDatabases", new Exception(e));
		}finally{
			try{
