...
public final class getAPILogs {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.dashboard.api_page.getAPILogs";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/dashboard/api_page/getAPILogs.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAPILogs", new Exception(e));
		}finally{
			try{
