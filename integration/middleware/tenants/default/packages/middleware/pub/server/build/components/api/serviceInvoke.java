package packages.middleware.pub.server.build.components.api;
...
public final class serviceInvoke {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.build.components.api.serviceInvoke";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/build/components/api/serviceInvoke.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute serviceInvoke", new Exception(e));
		}finally{
			try{
