package packages.middleware.pub.server.mcp;
...
public final class initialize {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.mcp.initialize";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/mcp/initialize.api");
