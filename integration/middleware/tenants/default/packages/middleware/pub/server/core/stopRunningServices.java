...
public final class stopRunningServices {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.core.stopRunningServices";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/core/stopRunningServices.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute stopRunningServices", new Exception(e));
		}finally{
			try{
