...
public final class getSchema {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.mcp.utils.getSchema";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/mcp/utils/getSchema.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getSchema", new Exception(e));
		}finally{
			try{
