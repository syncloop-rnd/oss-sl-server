...
public final class SystemEnvEndpoints {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.browse.SystemEnvEndpoints";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/browse/SystemEnvEndpoints.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute SystemEnvEndpoints", new Exception(e));
		}finally{
			try{
