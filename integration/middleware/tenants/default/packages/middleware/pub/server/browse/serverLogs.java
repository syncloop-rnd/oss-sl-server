...
public final class serverLogs {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.browse.serverLogs";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/browse/serverLogs.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute serverLogs", new Exception(e));
		}finally{
			try{
