package packages.middleware.pub.server.mcp.discover;
...
public final class tools {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.mcp.discover.tools";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/mcp/discover/tools.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute tools", new Exception(e));
		}finally{
			try{
