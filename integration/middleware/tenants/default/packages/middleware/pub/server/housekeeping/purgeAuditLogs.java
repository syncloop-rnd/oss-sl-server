package packages.middleware.pub.server.housekeeping;
...
public final class purgeAuditLogs {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.housekeeping.purgeAuditLogs";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/housekeeping/purgeAuditLogs.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute purgeAuditLogs", new Exception(e));
		}finally{
			try{
