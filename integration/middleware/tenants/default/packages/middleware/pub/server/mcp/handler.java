...
public final class handler {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.mcp.handler";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/mcp/handler.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute handler", new Exception(e));
		}finally{
			try{
