package packages.middleware.pub.server.dashboard.api_page;
...
public final class getAuditLogByFqn {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.dashboard.api_page.getAuditLogByFqn";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/dashboard/api_page/getAuditLogByFqn.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAuditLogByFqn", new Exception(e));
		}finally{
			try{
