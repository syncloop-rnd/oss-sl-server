...
public final class service {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.core.service";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/core/service.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute service", new Exception(e));
		}finally{
			try{
