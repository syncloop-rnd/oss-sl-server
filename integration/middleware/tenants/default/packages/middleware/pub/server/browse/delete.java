...
try {
            ...
            if(file.exists()) {
                ...
                dataPipeline.put("message", "File successfully deleted.");
            } else {
                dataPipeline.put("status", "404");
              	dataPipeline.setResponseStatus(404);
                dataPipeline.put("error", "File does not exist.");
                dataPipeline.appLog("EXECUTION_STOPPED", "File does not exist at location: " + location);
                return;
            }
    		...
    		dataPipeline.put("error", "Failed to delete: " + e.getMessage());
