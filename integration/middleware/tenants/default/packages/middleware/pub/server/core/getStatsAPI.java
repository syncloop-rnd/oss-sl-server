...
public final class getStatsAPI {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.core.getStatsAPI";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/core/getStatsAPI.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getStatsAPI", new Exception(e));
		}finally{
			try{
