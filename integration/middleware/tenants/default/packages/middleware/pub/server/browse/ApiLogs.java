...
public final class ApiLogs {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.browse.ApiLogs";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/browse/ApiLogs.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute ApiLogs", new Exception(e));
		}finally{
			try{
