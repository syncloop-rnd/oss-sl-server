...
public final class getAPIAuditList {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.dashboard.api_page.getAPIAuditList";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/dashboard/api_page/getAPIAuditList.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAPIAuditList", new Exception(e));
		}finally{
			try{
