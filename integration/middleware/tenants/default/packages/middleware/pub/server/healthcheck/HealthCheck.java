...
public final class HealthCheck {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.healthcheck.HealthCheck";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/healthcheck/HealthCheck.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute HealthCheck", new Exception(e));
		}finally{
			try{
