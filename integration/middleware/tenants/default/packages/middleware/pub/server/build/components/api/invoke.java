...
public final class invoke {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.build.components.api.invoke";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/build/components/api/invoke.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute invoke", new Exception(e));
		}finally{
			try{
