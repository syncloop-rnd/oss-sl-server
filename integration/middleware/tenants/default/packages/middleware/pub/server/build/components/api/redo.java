...
public final class redo {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.build.components.api.redo";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/build/components/api/redo.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute redo", new Exception(e));
		}finally{
			try{
