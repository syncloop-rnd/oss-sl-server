...
public final class createNewTenant {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.core.createNewTenant";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/core/createNewTenant.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createNewTenant", new Exception(e));
		}finally{
			try{
