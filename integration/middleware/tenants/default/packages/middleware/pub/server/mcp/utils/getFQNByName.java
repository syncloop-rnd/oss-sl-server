package packages.middleware.pub.server.mcp.utils;
...
public final class getFQNByName {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.mcp.utils.getFQNByName";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/mcp/utils/getFQNByName.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getFQNByName", new Exception(e));
		}finally{
			try{
