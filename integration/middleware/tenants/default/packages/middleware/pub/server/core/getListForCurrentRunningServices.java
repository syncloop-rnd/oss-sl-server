...
public final class getListForCurrentRunningServices {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.core.getListForCurrentRunningServices";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/core/getListForCurrentRunningServices.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getListForCurrentRunningServices", new Exception(e));
		}finally{
			try{
