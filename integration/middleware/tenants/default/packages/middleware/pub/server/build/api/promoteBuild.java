...
public final class promoteBuild {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.build.api.promoteBuild";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/build/api/promoteBuild.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute promoteBuild", new Exception(e));
		}finally{
			try{
