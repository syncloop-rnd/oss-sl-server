...
public final class switchCase {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.build.components.api.switchCase";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/build/components/api/switchCase.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute switchCase", new Exception(e));
		}finally{
			try{
