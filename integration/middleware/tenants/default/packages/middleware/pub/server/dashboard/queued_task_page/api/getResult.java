...
public final class getResult {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.dashboard.queued_task_page.api.getResult";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/dashboard/queued_task_page/api/getResult.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getResult", new Exception(e));
		}finally{
			try{
