...
public final class updateLicense {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.server.core.updateLicense";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/server/core/updateLicense.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateLicense", new Exception(e));
		}finally{
			try{
