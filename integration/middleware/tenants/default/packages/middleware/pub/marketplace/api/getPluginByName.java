...
public final class getPluginByName {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.marketplace.api.getPluginByName";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/marketplace/api/getPluginByName.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getPluginByName", new Exception(e));
		}finally{
			try{
