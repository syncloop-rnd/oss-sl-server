...
public final class getAllCategories {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.marketplace.api.getAllCategories";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/marketplace/api/getAllCategories.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAllCategories", new Exception(e));
		}finally{
			try{
