package packages.middleware.pub.marketplace.api;
...
public final class getPluginByNameAndCategory {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.marketplace.api.getPluginByNameAndCategory";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/marketplace/api/getPluginByNameAndCategory.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getPluginByNameAndCategory", new Exception(e));
		}finally{
			try{
