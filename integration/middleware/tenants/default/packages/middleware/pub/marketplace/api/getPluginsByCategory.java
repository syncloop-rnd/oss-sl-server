...
public final class getPluginsByCategory {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.marketplace.api.getPluginsByCategory";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/marketplace/api/getPluginsByCategory.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getPluginsByCategory", new Exception(e));
		}finally{
			try{
