...
public final class getPluginById {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.marketplace.api.getPluginById";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/marketplace/api/getPluginById.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getPluginById", new Exception(e));
		}finally{
			try{
