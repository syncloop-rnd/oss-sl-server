...
public final class getAllPlugins {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.marketplace.api.getAllPlugins";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/marketplace/api/getAllPlugins.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getAllPlugins", new Exception(e));
		}finally{
			try{
