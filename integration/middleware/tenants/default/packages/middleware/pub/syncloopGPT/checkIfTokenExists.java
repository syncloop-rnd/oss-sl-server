...
public final class checkIfTokenExists {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.syncloopGPT.checkIfTokenExists";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/syncloopGPT/checkIfTokenExists.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute checkIfTokenExists", new Exception(e));
		}finally{
			try{
