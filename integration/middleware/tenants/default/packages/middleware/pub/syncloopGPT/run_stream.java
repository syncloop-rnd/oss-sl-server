...
public final class run_stream {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.syncloopGPT.run_stream";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/syncloopGPT/run_stream.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute run_stream", new Exception(e));
		}finally{
			try{
