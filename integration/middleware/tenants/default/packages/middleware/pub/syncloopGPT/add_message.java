...
public final class add_message {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.syncloopGPT.add_message";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/syncloopGPT/add_message.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute add_message", new Exception(e));
		}finally{
			try{
