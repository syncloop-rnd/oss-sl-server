...
public final class get_results_through_assistant {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.syncloopGPT.get_results_through_assistant";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/syncloopGPT/get_results_through_assistant.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute get_results_through_assistant", new Exception(e));
		}finally{
			try{
