...
public final class create_run {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.syncloopGPT.create_run";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/syncloopGPT/create_run.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute create_run", new Exception(e));
		}finally{
			try{
