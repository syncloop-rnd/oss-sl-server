...
public final class create_assistant {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.syncloopGPT.create_assistant";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/syncloopGPT/create_assistant.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute create_assistant", new Exception(e));
		}finally{
			try{
