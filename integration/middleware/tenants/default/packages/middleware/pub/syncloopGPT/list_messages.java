...
public final class list_messages {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.syncloopGPT.list_messages";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/syncloopGPT/list_messages.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute list_messages", new Exception(e));
		}finally{
			try{
