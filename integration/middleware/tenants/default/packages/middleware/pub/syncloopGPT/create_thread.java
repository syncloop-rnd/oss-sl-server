...
public final class create_thread {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.syncloopGPT.create_thread";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/syncloopGPT/create_thread.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute create_thread", new Exception(e));
		}finally{
			try{
