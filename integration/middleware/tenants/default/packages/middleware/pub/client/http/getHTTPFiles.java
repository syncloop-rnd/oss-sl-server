...
public final class getHTTPFiles {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.client.http.getHTTPFiles";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/client/http/getHTTPFiles.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getHTTPFiles", new Exception(e));
		}finally{
			try{
