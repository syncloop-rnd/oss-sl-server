...
public final class requestAPI {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.client.http.requestAPI";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/client/http/requestAPI.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute requestAPI", new Exception(e));
		}finally{
			try{
