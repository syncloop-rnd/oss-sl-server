...
public final class SecuredRequestAPI {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.client.http.SecuredRequestAPI";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/client/http/SecuredRequestAPI.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute SecuredRequestAPI", new Exception(e));
		}finally{
			try{
