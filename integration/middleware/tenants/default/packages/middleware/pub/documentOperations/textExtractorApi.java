package packages.middleware.pub.documentOperations;
...
public final class textExtractorApi {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.documentOperations.textExtractorApi";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/documentOperations/textExtractorApi.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute textExtractorApi", new Exception(e));
		}finally{
			try{
