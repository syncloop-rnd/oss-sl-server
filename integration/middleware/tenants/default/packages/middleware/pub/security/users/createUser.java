...
public final class createUser {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.security.users.createUser";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/security/users/createUser.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createUser", new Exception(e));
		}finally{
			try{
