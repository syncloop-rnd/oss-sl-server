...
public final class initOIDCProfiles {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.security.initOIDCProfiles";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/security/initOIDCProfiles.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute initOIDCProfiles", new Exception(e));
		}finally{
			try{
