package packages.middleware.pub.security.flow;
...
public final class updateUserFlow {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.security.flow.updateUserFlow";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/security/flow/updateUserFlow.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateUserFlow", new Exception(e));
		}finally{
			try{
