package packages.middleware.pub.security;
...
public final class BasicLoginHandler {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.security.BasicLoginHandler";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/security/BasicLoginHandler.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute BasicLoginHandler", new Exception(e));
		}finally{
			try{
