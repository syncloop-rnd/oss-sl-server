...
public final class changePasswordFlow {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.security.flow.changePasswordFlow";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/security/flow/changePasswordFlow.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute changePasswordFlow", new Exception(e));
		}finally{
			try{
