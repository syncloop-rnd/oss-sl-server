package packages.middleware.pub.security.OIDCLogin.Keycloak;
...
public final class LoginHandler {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.security.OIDCLogin.Keycloak.LoginHandler";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/security/OIDCLogin/Keycloak/LoginHandler.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute LoginHandler", new Exception(e));
		}finally{
			try{
