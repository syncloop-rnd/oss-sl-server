...
public final class OIDCProfile {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.security.OIDCLogin.Google.OIDCProfile";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/security/OIDCLogin/Google/OIDCProfile.api");
