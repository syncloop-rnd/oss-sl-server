...
public final class OIDCProfile {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.security.OIDCLogin.Keycloak.OIDCProfile";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/security/OIDCLogin/Keycloak/OIDCProfile.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute OIDCProfile", new Exception(e));
		}finally{
			try{
