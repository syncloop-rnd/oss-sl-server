...
public final class getUsers {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.security.flow.getUsers";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/security/flow/getUsers.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getUsers", new Exception(e));
		}finally{
			try{
