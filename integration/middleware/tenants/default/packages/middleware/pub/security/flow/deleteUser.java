...
public final class deleteUser {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.security.flow.deleteUser";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/security/flow/deleteUser.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteUser", new Exception(e));
		}finally{
			try{
