...
public final class insertAuditLogginV2 {
		...
		try{
		  ...
		  if(mainSqlJsonObject==null)
			synchronized(syncBlock){
			  ...
			  String flowRef = location+"packages/middleware/pub/adapter/services/DML/insertAuditLogginV2.sql";
			  if(mainSqlJsonObject==null){
		  ...
		  SqlResolver.execute(dataPipeline,mainSqlJsonObject);
			...
			throw new SnippetException(dataPipeline,"Failed to execute insertAuditLogginV2", new Exception(e));
		}
	}
}
