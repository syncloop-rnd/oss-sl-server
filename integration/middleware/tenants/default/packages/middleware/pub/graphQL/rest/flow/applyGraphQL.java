package packages.middleware.pub.graphQL.rest.flow;
...
public final class applyGraphQL {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.graphQL.rest.flow.applyGraphQL";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/graphQL/rest/flow/applyGraphQL.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute applyGraphQL", new Exception(e));
		}finally{
			try{
