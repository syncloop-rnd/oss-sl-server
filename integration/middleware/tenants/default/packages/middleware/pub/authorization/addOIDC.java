package packages.middleware.pub.authorization;
...
public final class addOIDC {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.authorization.addOIDC";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/authorization/addOIDC.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute addOIDC", new Exception(e));
		}finally{
			try{
