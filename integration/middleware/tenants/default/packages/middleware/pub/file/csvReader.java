...
public final class csvReader {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.file.csvReader";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/file/csvReader.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute csvReader", new Exception(e));
		}finally{
			try{
