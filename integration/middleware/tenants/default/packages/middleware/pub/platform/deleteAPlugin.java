...
public final class deleteAPlugin {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.platform.deleteAPlugin";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/platform/deleteAPlugin.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteAPlugin", new Exception(e));
		}finally{
			try{
