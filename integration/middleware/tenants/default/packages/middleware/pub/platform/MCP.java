...
public final class MCP {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.platform.MCP";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/platform/MCP.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute MCP", new Exception(e));
		}finally{
			try{
