...
public final class MarketPlace {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.platform.MarketPlace";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/platform/MarketPlace.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute MarketPlace", new Exception(e));
		}finally{
			try{
