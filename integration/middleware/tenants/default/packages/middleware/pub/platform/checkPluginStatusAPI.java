...
public final class checkPluginStatusAPI {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.platform.checkPluginStatusAPI";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/platform/checkPluginStatusAPI.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute checkPluginStatusAPI", new Exception(e));
		}finally{
			try{
