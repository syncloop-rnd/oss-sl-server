...
try{
  ...
  dataPipeline.put("marketplace", com.eka.middleware.update.PluginInstaller.getMCPs(dataPipeline, start, length, category, name, sortBy));
  } catch (Exception e) {
  e.printStackTrace();
      dataPipeline.clear();
