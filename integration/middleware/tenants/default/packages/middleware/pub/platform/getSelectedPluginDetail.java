...
public final class getSelectedPluginDetail {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.platform.getSelectedPluginDetail";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/platform/getSelectedPluginDetail.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getSelectedPluginDetail", new Exception(e));
		}finally{
			try{
