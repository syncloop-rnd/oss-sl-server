...
public final class getPublicSelectedPluginDetail {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.platform.getPublicSelectedPluginDetail";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/platform/getPublicSelectedPluginDetail.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getPublicSelectedPluginDetail", new Exception(e));
		}finally{
			try{
