...
public final class installAPlugin {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.platform.installAPlugin";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/platform/installAPlugin.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute installAPlugin", new Exception(e));
		}finally{
			try{
