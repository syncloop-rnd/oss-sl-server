...
public final class syncPluginData {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.platform.syncPluginData";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/platform/syncPluginData.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute syncPluginData", new Exception(e));
		}finally{
			try{
