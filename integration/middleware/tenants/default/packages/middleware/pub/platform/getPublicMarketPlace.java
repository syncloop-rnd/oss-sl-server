...
public final class getPublicMarketPlace {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.platform.getPublicMarketPlace";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/platform/getPublicMarketPlace.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getPublicMarketPlace", new Exception(e));
		}finally{
			try{
