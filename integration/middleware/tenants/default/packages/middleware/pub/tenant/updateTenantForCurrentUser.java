...
public final class updateTenantForCurrentUser {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.tenant.updateTenantForCurrentUser";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/tenant/updateTenantForCurrentUser.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute updateTenantForCurrentUser", new Exception(e));
		}finally{
			try{
