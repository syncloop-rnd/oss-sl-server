...
public final class createNewTenantForCurrentUser {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.pub.tenant.createNewTenantForCurrentUser";
		...
		passThroughData.put("flowRef", "packages/middleware/pub/tenant/createNewTenantForCurrentUser.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute createNewTenantForCurrentUser", new Exception(e));
		}finally{
			try{
