...
public final class getGroups {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.mcp.tools.pub.security.flow.getGroups";
		...
		passThroughData.put("flowRef", "packages/middleware/mcp/tools/pub/security/flow/getGroups.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute getGroups", new Exception(e));
		}finally{
			try{
