package packages.middleware.mcp.tools.pub.security.flow;
...
public final class deleteGroup {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.mcp.tools.pub.security.flow.deleteGroup";
		...
		passThroughData.put("flowRef", "packages/middleware/mcp/tools/pub/security/flow/deleteGroup.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute deleteGroup", new Exception(e));
		}finally{
			try{
