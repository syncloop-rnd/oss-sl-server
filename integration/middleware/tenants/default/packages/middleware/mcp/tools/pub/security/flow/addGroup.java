...
public final class addGroup {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.middleware.mcp.tools.pub.security.flow.addGroup";
		...
		passThroughData.put("flowRef", "packages/middleware/mcp/tools/pub/security/flow/addGroup.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute addGroup", new Exception(e));
		}finally{
			try{
